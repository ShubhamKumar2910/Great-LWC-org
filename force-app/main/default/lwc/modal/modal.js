...
export default class Modal extends LightningElement {
    isFirstRender = true;
    isOpen = false;
    showFooter = false; //by default footer is kept as false, because we will be using individual lwc to perform actions
    ...
    @api
    toggleModal() {
        console.log('--- toggleModal--', this.isOpen);
        this.isOpen = !this.isOpen;
        if (this.isOpen) {
            this.focusFirstChild();
        }
        console.log('--- 2toggleModal--', this.isOpen);
