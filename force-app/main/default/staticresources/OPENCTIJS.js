...
/***/ (function(module, exports, __webpack_require__) {
	...
	var topFrameOriginPattern = /^http[s]?:\/\/[\w-.]+(\.force\.com|\.salesforce\.com|\.shnpoc\.net|\.myshnpoc\.net|\.myshn\.net)(:\d+)?$/;
	...
	module.exports = {
	    ...
	    */
	    ...
	    searchAndScreenPop: function searchAndScreenPop(args) {
	        utils.validateArguments(arguments);
	        var callback = args ? args.callback : undefined;
	        utils.invokeApiCall('searchAndScreenPop', { searchParams: args.searchParams, callType: args.callType, queryParams: args.queryParams, defaultFieldValues: args.defaultFieldValues, deferred: args.deferred }, callback);
	    },
