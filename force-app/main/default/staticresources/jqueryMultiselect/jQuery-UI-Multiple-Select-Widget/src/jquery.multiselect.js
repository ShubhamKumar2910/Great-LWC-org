...
(function($, undefined) {
  ...
  $.widget("ech.multiselect", {
    ...
    _create: function() {
	  ...
	  //Added Id attribute to use it in changing css used in NomuraSoftPhoneUILightning page. SALES-3119
      this.menu = $('<div />')
        .addClass('ui-multiselect-menu ui-widget ui-widget-content ui-corner-all ' + o.classes)
		.attr({ 'id': el.attr('id') ? el.attr('id') : null })
    ...
    */
    ...
    _setMenuHeight: function() {
	  ...
	  //commented out below because we dont need scrollbars - SALES-3119
