        ...
        action.setCallback(this,function(a){  
            ...
            if (state === "SUCCESS") { 
                ...
                if(grpFlag){
                    ...
                    //console.log("Set Id in lookup component :: "+ component.find("lookup-contact").get("v.preSelectedIds"));
    ...
    getSponsorId : function(component){
        ...
        console.log("get sponsor Id");
            ...
            if (state === "SUCCESS") { 
                ...
                //component.find("lookup-contact").set("v.preSelectedIds" , a.getReturnValue()/*component.get("v.contactInfo").Id till here);
